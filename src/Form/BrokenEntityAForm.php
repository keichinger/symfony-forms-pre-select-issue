...
class BrokenEntityAForm extends AbstractType
{
    /**
     * @inheritdoc
     */
    ...
    {
        $builder
            ->add("_someUnmappedPropertyThatIsBreakingFormsDataBindingInPostSetData", FormType::class, [
                "label" => false,
                "inherit_data" => true,
            ]);
        ...
        $builder
            ->get("_someUnmappedPropertyThatIsBreakingFormsDataBindingInPostSetData")
            ->add("something", null, [
        ...
        $builder
            ->addEventListener(FormEvents::POST_SET_DATA, static function (FormEvent $event) : void
            {
                ...
                $thisIsBreakingFormsDataBindingInPostSetData = $form->get("_someUnmappedPropertyThatIsBreakingFormsDataBindingInPostSetData");

                $thisIsBreakingFormsDataBindingInPostSetData
